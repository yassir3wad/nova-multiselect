...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-multi-select-field', __webpack_require__(3));
    Vue.component('detail-multi-select-field', __webpack_require__(6));
    Vue.component('form-multi-select-field', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c(
    "div",
    _vm._l(JSON.parse(_vm.field.value), function(segment) {
      return _c("span", { staticClass: "m-1 p-2 rounded-lg bg-primary-10%" }, [
        _vm._v(_vm._s(segment.label))
      ])
    }),
    0
  )
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex border-b border-40" }, [
    ...
    _c(
      ...
      _vm._l(_vm.value, function(segment) {
        return _c(
          "span",
          { staticClass: "m-1 p-2 rounded-lg bg-primary-10%" },
          [_vm._v(_vm._s(segment.label))]
        )
      }),
      0
...
var update = __webpack_require__(13)("30bbe8cf", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_multiselect__ = __webpack_require__(17);
